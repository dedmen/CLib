////////////////////////////////////////////////////////////////////
//DeRap: Produced from mikero's Dos Tools Dll version 5.82
//'now' is Sun Nov 20 01:15:24 2016 : 'file' last modified on Sun Nov 20 01:15:24 2016
//http://dev-heaven.net/projects/list_files/mikero-pbodll
////////////////////////////////////////////////////////////////////

#define _ARMA_

//Class CLib : config.cpp{
class CfgPatches
{
	class CLib
	{
...
class CfgCLibModules
{
	class CLib
	{
		...
		class Core
		{
			...
			class Autoload
			{
				class autoloadEntryPoint;
				class callModules;
				class loadModules
				{
					api = 1;
				};
				class loadModulesServer;
				class sendFunctions;
				class sendFunctionsLoop;
			};
			class Misc
			{
				class addPerformanceCounter
				{
					api = 1;
				};
				class blurScreen
				...
				class dumpPerformanceInformation;
				class setVariablePublic
				{
					api = 1;
				};
			};
			class MissionModuleLoader
			{
				class postInit;
			};
		};
		...
		class Localisation
		{
			...
			class readLocalisation
			{
				api = 1;
			};
			class formatLocalisation
			{
				api = 1;
			};
		};
		...
		class 3dGraphics
		{
			...
			class build3dGraphicsCache
			{
				api = 1;
			};
			class clientInit;
			class draw3dGraphics
			{
				api = 1;
			};
			class remove3dGraphics
			{
				api = 1;
			};
		};
		class extensionFramework
		{
			...
			class init;
			class remoteCallExtension
			{
				api = 1;
			};
			class splitOutputString
			{
				api = 1;
			};
		};
		...
		class Interaction
		{
			...
			class clientInitCanInteractWith;
			class clientInitInteraction;
		...
		{
			dependency[] = {"CLib/Events"};
			class addMapGraphicsEventHandler
			{
				api = 1;
			};
			class addMapGraphicsGroup
			{
				api = 1;
			};
			class buildMapGraphicsCache
			{
				api = 1;
			};
			class clientInit;
			class drawMapGraphics
			{
				api = 1;
			};
			class mapGraphicsMouseButtonClick
			{
				api = 1;
			};
			class mapGraphicsMouseMoving
			{
				api = 1;
			};
			class mapGraphicsPosition
			{
				api = 1;
			};
			class nearestMapGraphicsGroup
			{
				api = 1;
			};
			class removeMapGraphicsEventhandler
			{
				api = 1;
			};
			class removeMapGraphicsGroup
			{
				api = 1;
			};
			class TriggerMapGraphicsEvent
			{
				api = 1;
			};
			class registerMapControl
			{
				api = 1;
			};
			class unregisterMapControl
			{
				api = 1;
			};
		};
		...
		class Statemachine
		{
			...
			class createStatemachineFromConfig
			{
				api = 1;
			};
			class getVariableStatemachine
			{
				api = 1;
			};
			class init;
			class setVariableStatemachine
			{
				api = 1;
			};
		...
		class SimpleObjectFramework
		{
			dependency[] = {"CLib/Namespaces"};
			class createSimpleObjectComp
			{
				api = 1;
			};
			class init;
			class readSimpleObjectComp
			{
				api = 1;
			};
			class exportSimpleObjectComp
			{
				api = 1;
				serverOnly = 1;
			};
